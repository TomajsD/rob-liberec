...
Tags: editorial calendar, content notifications, editorial comments, slack notifications, content planning
...
[Click here to read about the Content Calendar screen](https://publishpress.com/knowledge-base/calendar/).
...
## Content Notifications via Slack ## 
...
## Content Notification Reminders ## 
...
Bug reports for PublishPress Planner are welcomed in our [repository on GitHub](https://github.com/publishpress/publishpress-planner). Please note that GitHub is not a support forum, and that issues that are not properly qualified as bugs will be closed.

= Thank You = 

PublishPress was originally based on the Edit Flow plugin which was built by Daniel Bachhuber, Scott Bressler, Mohammad Jangda, Automattic, and others.
...
= Can I create content on the Editorial Calendar? =

You can create new content directly from the calendar. Simply click on any date in the calendar, and you'll see a pop-up. You can extend the Editorial Metadata feature so you can add metadata when creating posts on the calendar.

= Does PublishPress Planner Work with iCal and Google Calendar? =

You can share updates from your PublishPress Planner Calendar. These updates can be pushed to Google Calendar or any calendar that supports iCal. You will see a link in the top-right corner of your calendar that says “Click here to Subscribe in iCal or Google Calendar”. This link will export the details of the content from your PublishPress Planner calendar. You can choose how far into the past (Start date) and how far into the future (End date) your calendar goes. You can either download the .ics file or you can copy the URL for your calendar.

[Click here to read about iCal and Google Calendar integration](https://publishpress.com/knowledge-base/export/).

= What are the default notifications available? =

PublishPress Planner provides two default notifications:

* Notify when content is published: this sends an email to Site Administrators whenever content is moved to the “Published” status.
* Notify on editorial comments: this sends an email to Site Administrators whenever an editorial comment is added.

[Click here to read about the default notifications](https://publishpress.com/knowledge-base/notifications/).

= How Do I import to PublishPress Planner From Edit Flow? =

PublishPress Planner is based on the Edit Flow plugin. It is easy for Edit Flow users to import your data and settings.

[Click here to read about the Edit Flow import](https://publishpress.com/knowledge-base/migrate/).

= How Does PublishPress Planner Compare to Multicollab? =

PublishPress Planner does have an Editorial Comments feature as does the Multicollab plugin. PublishPress Planner is different from Multicollab in two ways. First, PublishPress Planner works with more than just the Gutenberg editor. Second. PublishPress Planner has other key features beyond just the Editorial Comments feature.
