...
$mif_personal_clients = array( '7990630550950691' );
		...
		<div class="mif_wrap_inner">
			<div class="mif_tabs_holder">
				...
				<div class="mif_tab_c_holder">
					<?php require_once ESF_INSTA_PLUGIN_DIR . 'admin/views/html-autenticate-tab.php'; ?>
					<?php require_once ESF_INSTA_PLUGIN_DIR . 'admin/views/html-how-to-use-tab.php'; ?>
					<?php require_once ESF_INSTA_PLUGIN_DIR . 'admin/views/html-skins-tab.php'; ?>
					<?php require_once ESF_INSTA_PLUGIN_DIR . 'admin/views/html-moderate-tab.php'; ?>
					<?php require_once ESF_INSTA_PLUGIN_DIR . 'admin/views/html-clear-cache-tab.php'; ?>
