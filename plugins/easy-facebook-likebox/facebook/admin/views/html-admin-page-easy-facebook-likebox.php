	...
	<div class="efbl_wrap z-depth-1">
		<div class="efbl_wrap_inner">
			...
			<div class="efbl_tab_c_holder">
				<?php require_once EFBL_PLUGIN_DIR . 'admin/views/html-authenticate-tab.php'; ?>
				<?php require_once EFBL_PLUGIN_DIR . 'admin/views/html-how-to-use-tab.php'; ?>
				<?php require_once EFBL_PLUGIN_DIR . 'admin/views/html-moderate-tab.php'; ?>
				<?php require_once EFBL_PLUGIN_DIR . 'admin/views/html-skins-tab.php'; ?>
				<?php require_once EFBL_PLUGIN_DIR . 'admin/views/html-likebox-tab.php'; ?>
				<?php require_once EFBL_PLUGIN_DIR . 'admin/views/html-clear-cache-tab.php'; ?>
...
<div id="efbl-addon-upgrade" class="fta-upgrade-modal esf-modal fadeIn">
	<div class="modal-content">
		<div class="mif-modal-content"><span class="mif-lock-icon"><span class="dashicons dashicons-lock"></span></span>
			...
			<p><?php esc_html_e( 'The Multifeed add-on gives you the ability to display multiple posts or events from multiple Facebook accounts in one single feed ordered by date.', 'easy-facebook-likebox' ); ?>
